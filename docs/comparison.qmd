...
This document compares the seriation methods available in the package `seriation` using the popular Iris dataset and randomizes the order of the objects.
