 ...
 *  **MDS** - Multidimensional scaling (classical metric MDS, Krusakl's isoMDS, 
          Sammon's non-linear mapping, angle in 2D principal coordinates space, 
          stress minimization using majorization) 
