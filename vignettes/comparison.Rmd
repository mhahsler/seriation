...
vignette: >
    %\VignetteIndexEntry{A Comparison of Seriation Methods}
...
This document compares the seriation methods available in the package `seriation` using 
a sample of 30 flowers from the popular Iris dataset and randomizes the order of the objects.
